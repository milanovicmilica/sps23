...
@Component({
  selector: 'app-loginarchive',
  templateUrl: './loginarchive.component.html',
  styleUrls: ['./loginarchive.component.css']
})
export class LoginarchiveComponent implements OnInit {
