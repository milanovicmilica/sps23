...
function onGlobalKeyPressed(e) {
    ...
    if (charCode != 13) { // ascii 13 is return key
        ...
        //if (checkIfScannedCodeExists(lastCode) == false) {
            ...
            //var ind=listOfScannedBarCodes.length;
          //  listOfScannedBarCodes.push(lastCode);
          //  var t=ind-1;
            //document.getElementsByName('casette[t]').innerHTML=lastCode
            
          document.getElementById('basc').innerHTML=lastCode;
          listOfScannedBarCodes.push(lastCode);
       //   lastCode = document.createElement('LABEL');
        //  document.getElementById('lab').appendChild(lastCode);   
          for (let index = 0; index < listOfScannedBarCodes.length; index++) {
            document.getElementById('casette').innerHTML+=listOfScannedBarCodes[index];
            
          }  
          //document.getElementById('lab').innerHTML=listOfScannedBarCodes;     
        //}
