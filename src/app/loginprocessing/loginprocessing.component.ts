...
@Component({
  selector: 'app-loginprocessing',
  templateUrl: './loginprocessing.component.html',
  styleUrls: ['./loginprocessing.component.css']
})
export class LoginprocessingComponent implements OnInit {
